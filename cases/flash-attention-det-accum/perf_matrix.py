...
CASES = [
    ...
    ("tnd_large_mha_causal", "TND", "1×4096·c·H4/4·D128"),
    ("tnd_large_mha_nc", "TND", "1×4096·nc·H4/4·D128"),
]

# 图中用短标签（横轴空间有限）
SHORT = [
    "b1 n2 g1 s2=128 s1=128 d=128 c",
    "b1 n2 g1 s2=128 s1=128 d=128 nc",
    "b2 n2 g2 s2=300 s1=200 d=64 c",
    "b2 n1 g4 s2=500 s1=300 d=64 nc",
    "b2 n4 g1 s2=77 s1=33 d=64 c",
    "b1 n8 g1 s2=1024 s1=1024 d=128 c",
    "b1 n8 g1 s2=1024 s1=1024 d=128 nc",
    "b2 n4 g1 s2=777 s1=333 d=64 c",
    "b2 n4 g1 s2=333 s1=777 d=64 nc",
    "b1 n2 g4 s2=1024 s1=1024 d=128 c",
    "b1 n2 g4 s2=1024 s1=1024 d=128 nc",
    "b2 n1 g4 s2=500 s1=300 d=64 c",
    "b2 n1 g4 s2=500 s1=300 d=64 nc",
    "b2 n3 g2 s2=900 s1=500 d=128 c",
    "b2 n3 g2 s2=900 s1=500 d=128 nc",
    "b2 n3 g2 s2=333 s1=777 d=64 nc",
    "b1 n8 g1 s2=2048 s1=2048 d=128 c",
    "b1 n8 g1 s2=2048 s1=2048 d=128 nc",
    "b1 n2 g4 s2=2048 s1=2048 d=128 c",
    "b1 n4 g1 s2=4096 s1=4096 d=128 c",
    "b1 n4 g1 s2=4096 s1=4096 d=128 nc",
    "b2 n4 g1 s2=256+384 s1=256+384 d=128 c",
    "b2 n4 g1 s2=256+384 s1=256+384 d=128 nc",
    "b2 n1 g4 s2=300+1300 s1=100+800 d=64 c",
    "b2 n1 g4 s2=300+400 s1=100+800 d=64 nc",
    "b2 n4 g1 s2=300+400 s1=100+800 d=64 nc",
    "b2 n2 g2 s2=768+1280 s1=512+1024 d=128 c",
    "b2 n2 g2 s2=768+1280 s1=512+1024 d=128 nc",
    "b2 n8 g1 s2=2048 s1=2048 d=128 c",
    "b2 n8 g1 s2=2048 s1=2048 d=128 nc",
    "b2 n2 g4 s2=1024 s1=1024 d=128 c",
    "b2 n2 g4 s2=1024 s1=1024 d=128 nc",
    "b8 n8 g1 s2=512 s1=512 d=128 c",
    "b8 n8 g1 s2=512 s1=512 d=128 nc",
    "b1 n4 g1 s2=4096 s1=4096 d=128 c",
    "b1 n4 g1 s2=4096 s1=4096 d=128 nc",
]

OURS_DET = [
    23.5, 18.0, 23.9, 33.9, 19.1, 74.4, 107.3, 37.7, 36.5, 98.1, 103.3, 35.6, 33.8, 65.2, 64.3, 42.0, 183.8, 317.1, 247.5, 329.4, 540.7, 29.2, 35.5, 55.3, 52.5, 33.1, 63.5, 66.4, 379.4, 594.9, 112.9, 145.1, 180.5, 301.4, 276.8, 529.1,
]

OURS_ND = [
    14.5, 14.6, 19.8, 30.7, 13.9, 61.6, 82.1, 30.4, 32.4, 81.1, 96.3, 29.3, 29.6, 55.3, 60.0, 37.7, 143.2, 222.2, 182.5, 247.9, 444.5, 20.6, 22.4, 60.7, 49.7, 34.0, 53.4, 88.6, 265.0, 446.4, 118.8, 167.3, 144.8, 164.2, 246.4, 458.8,
]

OPST_DET = [
    10.1, 9.8, 25.0, 33.2, 8.5, 59.5, 70.2, 25.2, 26.7, 75.9, 73.2, 33.1, 33.1, 37.2, 50.2, 35.2, 118.3, 176.7, 140.0, 177.7, 300.7, 37.0, 35.7, 71.2, 61.3, 37.4, 65.2, 58.1, 252.6, 365.5, 88.1, 91.0, 140.9, 180.9, None, 304.3,
]

OPST_ND = [
    10.2, 9.8, 19.1, 22.7, 8.6, 45.8, 57.5, 22.1, 25.4, 42.3, 54.5, 21.3, 21.8, 31.1, 46.6, 29.4, 103.4, 154.4, 94.1, 163.2, 277.3, 24.6, 24.3, 27.9, 25.6, 26.8, 36.2, 49.0, 181.3, 332.9, 63.3, 87.8, 79.5, 134.1, None, 269.5,
]
