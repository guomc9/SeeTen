...
| `out/v4-index-schedules.pptx` | The generated pages (21: overview + axis walkthrough + virtual-column page + 7 methods x 2 + a harder non-square causal example + three performance comparison pages) |
